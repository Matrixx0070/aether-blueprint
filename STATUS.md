...
| Z7 | DONE | (this commit) | n/a | v0.30.0 ship: workspace bump + 15 internal dep pins + ROADMAP + STATUS + Plan AA draft + tag + push + cosign verify-blob | Plan Z wrap-up + v0.30.0 ship |
