...
| CC7 | DONE | (this commit) | n/a | v0.33.0 ship: workspace bump + 15 internal dep pins + ROADMAP + STATUS + Plan DD draft + tag + push; 4-platform autobuild green; cosign verify-blob → "Verified OK"; ./aether --version → aether 0.33.0 from published artifact | Plan CC wrap-up + v0.33.0 ship — every AA + BB weakest-point closed |
