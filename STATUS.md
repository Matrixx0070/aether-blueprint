...
| BB7 | DONE | (this commit) | n/a | v0.32.0 ship: workspace bump + 15 internal dep pins + ROADMAP + STATUS + Plan CC draft + tag + push; 4-platform autobuild green; cosign verify-blob → "Verified OK"; ./aether --version → aether 0.32.0 from published artifact | Plan BB wrap-up + v0.32.0 ship |
