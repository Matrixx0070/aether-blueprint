...
| AA7 | DONE | (this commit) | n/a | v0.31.0 ship: workspace bump + 15 internal dep pins + ROADMAP + STATUS + Plan BB draft + tag + push; 4-platform autobuild green; cosign verify-blob → "Verified OK"; ./aether --version → aether 0.31.0 from published artifact | Plan AA wrap-up + v0.31.0 ship |
