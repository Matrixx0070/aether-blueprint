...
| DD7 | DONE | (this commit) | n/a | v0.34.0 ship: workspace bump + 15 internal dep pins + ROADMAP + STATUS + Plan EE draft + tag + push; 4-platform autobuild green; cosign verify-blob → "Verified OK"; ./aether --version → aether 0.34.0 from published artifact | Plan DD wrap-up + v0.34.0 ship — AA→BB→CC→DD chain complete across all 3 lanes |
